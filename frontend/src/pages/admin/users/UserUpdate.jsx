...
} from "../../../validations/admin/UsersValidation";
...
const UserUpdate = ({ setShowUpdateModel, userUpdateId }) => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      await dispatch(FetchUserThunk(userUpdateId));
    };
    fetchUser();
  }, [userUpdateId]);
  ...
  useEffect(() => {
    if (user) {
      ...
      setFieldValue("is_active", user.is_active?.toString() || "");
      setFieldValue("email", user.email || "");
      setFieldValue("mobile", user.mobile || "");
      setFieldValue("profile", user.profile || "");
  ...
  return (
    <div className="min-h-md w-full bg-white">
      ...
      <form onSubmit={handleSubmit} className="">
        <div className="w-full p-1 lg:p-1 font-sans">
          <div className="max-w-8xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-4">
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300 sticky top-1">
                  <div className="bg-gradient-to-r from-orange-50 to-white px-8 py-5 border-b border-gray-200">
                    <div className="flex items-center gap-3 rounded-xl">
                      ...
                      <div>
                        <h2 className="text-xl rounded-2xl font-bold text-gray-800">
                          Profile Picture
                        </h2>
                        <p className="text-sm text-gray-500">
                          Upload user avatar
        ...
        <div className="flex justify-end gap-3 p-4  bg-white-50">
          <button
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`px-4 py-2 text-sm font-semibold rounded-lg transition flex items-center justify-center gap-2
    ${
      isLoading
